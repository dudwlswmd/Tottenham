  ...
  return (
    <div className='w-full max-w-screen-xl m-auto py-24 md:py-40'>
      <section className="flex flex-col gap-4 md:gap-12 md:flex-row p-4">
        <img className='w-full max-w-3xl basis-4/12' src={image} alt={title} />
        <div className='w-full basis-6/12 flex flex-col p-8 md:p-0'>
          <p className='text-slate-700'>스퍼스 유니폼 / {category}</p>
